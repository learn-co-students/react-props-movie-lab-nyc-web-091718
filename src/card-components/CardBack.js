...
export default class CardBack extends Component {
  ...
  generateRatingElement = () => {
    ...
    if (this.props.IMDBRating === null) {
      return (<h4 className="rating">No Rating Found</h4>);
    } else {
      return (<img src={imgMapper[this.props.IMDBRating]} alt=""/>);
    }
    // this.props.IMDBRating == null ? <h4 className="rating">No Rating Found</h4> : <img src={imgMapper[this.props.IMDBRating]} alt=""/>
  }
